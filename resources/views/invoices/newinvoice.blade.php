                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="container mt-5">
                                    ...
                                    <form action="{{ route('invoices.add') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="heading" class="form-label">optician</label>
                                            <input type="text" class="form-control @error('optician') is-invalid @enderror" id="optician" name="optician" value="{{ old('optician') }}">
                                            @error('optician')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            <label for="heading" class="form-label">clerk</label>
                                            <input type="text" class="form-control @error('clerk') is-invalid @enderror" id="heading" name="clerk" value="{{ old('clerk') }}">
                                            @error('clerk')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
